/**
 * Type definitions for the bundled Latin corpus at data/pro-marcello-la/.
 *
 * Generated (do not hand-edit) by
 *   npm run import:pro-marcello-la  (scripts/import-pro-marcello-la/index.ts)
 * and validated by
 *   npm run validate:pro-marcello-la  (scripts/import-pro-marcello-la/validate.ts)
 *
 ...
 * found no public-domain, COMPLETE English translation of this speech that
 * meets this app's two-source policy. A partial 19th-century translation
 * exists on English Wikisource but was deliberately not used - see
 * about.json).
 *
 * Flat, single-tier Division pattern (mirrors data/categoriae-la/): Cicero's
 * *Pro Marcello* is one continuous oration divided only into the numbered
...
export interface Division {
  ...
  id: string;
  /** the section number as a string, e.g. '1'..'34' */
  number: string;
