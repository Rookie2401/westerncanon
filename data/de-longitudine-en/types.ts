/**
 * Type definitions for the bundled English *On Longevity and Shortness of Life* (De longitudine et brevitate vitae) corpus in
 *   data/de-longitudine-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:de-longitudine-en    (scripts/import-de-longitudine-en/index.ts)
 * and validated by
 *   npm run validate:de-longitudine-en  (scripts/import-de-longitudine-en/validate.ts)
 *
 * Source: English Wikisource, page "On Longevity and Shortness of Life" -
 * G. R. T. Ross's translation, published in *The Works of Aristotle Translated
 * into English*, Volume III: Parva Naturalia (Oxford: Clarendon Press, 1908).
 * Public domain: published well before 1929.
 *
 * The page is ORDINARY WIKITEXT (15 KB of real prose), not a djvu page-scan
 * transclusion, and prints no Bekker page/column markers - so every
 * Division.ref here is null. Chapters are marked `==Part N==` and all 6
 * chapters of the standard division are present, complete and untruncated. A
 * trailing "External links" section is page furniture and is skipped.
 *
