 ...
 * across all 14 Xenophon English work directories - see
 ...
 * language: 'en' - the Loeb Classical Library English translation ("Xenophon in Seven Volumes", Harvard University Press / William Heinemann, 1914-1925)
 *
...
export interface Passage {
  ...
  n: string;
  /** verbatim English paragraph text: entities decoded, NFC-normalised, whitespace collapsed */
  text: string;
