/**
 * Type definitions for the bundled Epistulae ad Quintum Fratrem (Selection) corpus in
 *   data/ad-quintum-fratrem-selection-la/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-quintum-fratrem-selection-la  (scripts/import-ad-quintum-fratrem-selection-la/index.ts)
 * and validated by
 *   npm run validate:ad-quintum-fratrem-selection-la  (scripts/import-ad-quintum-fratrem-selection-la/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi058 (textgroup phi0474, M. Tullius Cicero). Latin witness perseus-lat1 (ed. Purser).
 *
