/**
 * Type definitions for the bundled Epistulae ad Atticum (Selection) corpus in
 *   data/ad-atticum-selection-la/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-atticum-selection-la  (scripts/import-ad-atticum-selection-la/index.ts)
 * and validated by
 *   npm run validate:ad-atticum-selection-la  (scripts/import-ad-atticum-selection-la/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi057 (textgroup phi0474, M. Tullius Cicero). Latin witness perseus-lat1 (ed. Purser).
 *
