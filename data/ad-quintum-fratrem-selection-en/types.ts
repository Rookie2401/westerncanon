/**
 * Type definitions for the bundled Letters to his Brother Quintus (Selection) corpus in
 *   data/ad-quintum-fratrem-selection-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-quintum-fratrem-selection-en  (scripts/import-ad-quintum-fratrem-selection-en/index.ts)
 * and validated by
 *   npm run validate:ad-quintum-fratrem-selection-en  (scripts/import-ad-quintum-fratrem-selection-en/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi058 (textgroup phi0474, M. Tullius Cicero). English witness perseus-eng1 (trans. Evelyn S. Shuckburgh, 1899-1900).
 *
