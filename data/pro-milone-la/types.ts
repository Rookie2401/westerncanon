/**
 * Type definitions for the bundled Latin corpus at data/pro-milone-la/.
 *
 * Generated (do not hand-edit) by
 *   npm run import:pro-milone-la  (scripts/import-pro-milone-la/index.ts)
 * and validated by
 *   npm run validate:pro-milone-la  (scripts/import-pro-milone-la/validate.ts)
 *
 ...
 * *Pro Milone* is one continuous oration divided only into the numbered
...
export interface Division {
  ...
  id: string;
  /** the section number as a string, e.g. '1'..'105' */
  number: string;
