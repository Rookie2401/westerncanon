/**
 * Type definitions for the bundled English *On Memory and Reminiscence* (De memoria et reminiscentia) corpus in
 *   data/de-memoria-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:de-memoria-en    (scripts/import-de-memoria-en/index.ts)
 * and validated by
 *   npm run validate:de-memoria-en  (scripts/import-de-memoria-en/validate.ts)
 *
 * Source: English Wikisource, page "On Memory and Reminiscence" - John Isaac
 ...
 *
 * The page is ORDINARY WIKITEXT (28 KB of real prose), not a djvu page-scan
 ...
 * matches the standard division exactly: 2 chapters, complete, untruncated.
 *
