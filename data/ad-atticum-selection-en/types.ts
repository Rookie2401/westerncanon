/**
 * Type definitions for the bundled Letters to Atticus (Selection) corpus in
 *   data/ad-atticum-selection-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-atticum-selection-en  (scripts/import-ad-atticum-selection-en/index.ts)
 * and validated by
 *   npm run validate:ad-atticum-selection-en  (scripts/import-ad-atticum-selection-en/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi057 (textgroup phi0474, M. Tullius Cicero). English witness perseus-eng1 (trans. Evelyn S. Shuckburgh, 1899-1900).
 *
