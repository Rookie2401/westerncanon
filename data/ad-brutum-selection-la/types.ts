/**
 * Type definitions for the bundled Epistulae ad M. Brutum (Selection) corpus in
 *   data/ad-brutum-selection-la/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-brutum-selection-la  (scripts/import-ad-brutum-selection-la/index.ts)
 * and validated by
 *   npm run validate:ad-brutum-selection-la  (scripts/import-ad-brutum-selection-la/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi059 (textgroup phi0474, M. Tullius Cicero). Latin witness perseus-lat1 (ed. Purser).
 *
