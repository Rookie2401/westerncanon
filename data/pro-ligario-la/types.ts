/**
 * Type definitions for the bundled Latin corpus at data/pro-ligario-la/.
 *
 * Generated (do not hand-edit) by
 *   npm run import:pro-ligario-la  (scripts/import-pro-ligario-la/index.ts)
 * and validated by
 *   npm run validate:pro-ligario-la  (scripts/import-pro-ligario-la/validate.ts)
 *
 ...
 * *Pro Ligario* is one continuous oration divided only into the numbered
...
export interface Division {
  ...
  id: string;
  /** the section number as a string, e.g. '1'..'38' */
  number: string;
