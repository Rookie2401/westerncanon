/**
 * Type definitions for the bundled Letters to his Friends (Selection) corpus in
 *   data/ad-familiares-selection-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-familiares-selection-en  (scripts/import-ad-familiares-selection-en/index.ts)
 * and validated by
 *   npm run validate:ad-familiares-selection-en  (scripts/import-ad-familiares-selection-en/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi056 (textgroup phi0474, M. Tullius Cicero). English witness perseus-eng1 (trans. Evelyn S. Shuckburgh, 1899-1900).
 *
