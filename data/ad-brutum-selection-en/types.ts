/**
 * Type definitions for the bundled Letters to Brutus (Selection) corpus in
 *   data/ad-brutum-selection-en/
 *
 * Generated (do not hand-edit) by
 *   npm run import:ad-brutum-selection-en  (scripts/import-ad-brutum-selection-en/index.ts)
 * and validated by
 *   npm run validate:ad-brutum-selection-en  (scripts/import-ad-brutum-selection-en/validate.ts)
 *
 * Source: Perseus / OpenGreekAndLatin canonical-latinLit TEI XML, CTS work
 * urn:cts:latinLit:phi0474.phi059 (textgroup phi0474, M. Tullius Cicero). English witness perseus-eng1 (trans. Evelyn S. Shuckburgh, 1899-1900).
 *
