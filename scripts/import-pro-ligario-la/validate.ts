/**
 * Validation for data/pro-ligario-la/.
 *
 *   npx tsx scripts/import-pro-ligario-la/validate.ts
 *
 * Writes data/pro-ligario-la/VALIDATION_REPORT.md, prints a summary, and
...
import type { Division, GenericWork } from '../../data/pro-ligario-la/types.ts';

const HERE = dirname(fileURLToPath(import.meta.url));
const REPO_ROOT = join(HERE, '..', '..');
const DIR = join(REPO_ROOT, 'data', 'pro-ligario-la');
const WORK_ID = 'pro-ligario-la';
const EXPECTED_SECTIONS = 38;
const EXPECTED_CHAPTERS = 12;
const SPOT_START = 'novum crimen, C. Caesar, et ante hunc diem non auditum propinquus meus';
const SPOT_END = 'si illi absenti salutem dederis, praesentibus te his daturum.';
