/**
 * The byte-identical `types.ts` written into every `data/<playwright>-<slug>-
 * grc|en/` output directory - mirrors the convention used for the Archimedes
 * corpus (scripts/import-archimedes-shared/typesTemplate.ts) and the
 * Nicomachean Ethics/Euclid/Homer works: one canonical string here rather
 * than hand-duplicated per play.
 */
export const DRAMA_TYPES_FILE = `/**
