...
export const GRC_ABOUT_SECTIONS: AboutSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Corrected transcription errors (verified against print). The work’s opening paragraph was checked letter-for-letter against Busse’s original 1887 printed edition (Internet Archive identifier p1porphyriiisago04porp, p. 1). Two single-letter corruptions, both producing non-words, were found and corrected: "ὑψέστηκεν" (a nonsense form) restored to the printed "ὑφέστηκεν" ("whether it subsists"), and "οἱ καλαιοὶ" (also nonsense) restored to the printed "οἱ παλαιοὶ" ("the ancients"). Unlike the uncorrected irregularities noted above, these two were individually confirmed against the source page before being changed.',
    ],
  },
];
...
export const LA_ABOUT_SECTIONS: AboutSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Division scheme: a preface followed by twenty-six capitula — the five predicables (genus, species, differentia, proprium, accidens), the chapter on features common to all five, and twenty paired "common / distinctive" comparison chapters. The standing reference edition for the Latin division is Aristoteles Latinus I.6–7, ed. L. Minio-Paluello with B. G. Dod (Bruges–Paris, 1966), pp. 5–31. This scheme has now been checked against that edition as reproduced in the DigilibLT digital corpus (Biblioteca Digitale di Testi Latini Tardoantichi, digiliblt.uniupo.it): Minio-Paluello’s text divides Boethius’ translation into exactly this praefatio-plus-26-capitula structure, which is also matched by the two witnesses consulted earlier — Busse’s Greek capitula (CAG IV.1, 1887) and a Busse-paginated text of the translation. The praefatio + 26 division is therefore confirmed, not provisional.',
    ],
  },
  {
    heading: 'Reference scheme',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Section count. An earlier query asked whether the Latin should carry 24 sections rather than 26. Collation against Minio-Paluello’s Aristoteles Latinus I.6–7 text (via DigilibLT) confirms the preface-plus-26 division and gives no support to a 24-section scheme. See "The edition" above.',
