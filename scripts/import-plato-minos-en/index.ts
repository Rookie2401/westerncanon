/**
 * Plato, Minos — English translation (Plato in Twelve Volumes,
 * Loeb Classical Library; CTS urn:cts:greekLit:tlg0059.tlg033.perseus-eng2).
 * Run-once ingestion pipeline built on the shared tokenizer in
 * scripts/import-plato-b-shared/parse.ts.
 *
 *   npx tsx scripts/import-plato-minos-en/index.ts
 *
 * Reads scripts/import-plato-minos-en/raw/tlg0059.tlg033.perseus-eng2.xml
 * (already in the repo; nothing is downloaded) and writes
 *   data/plato-minos-en/{work.json,about.json,anomalies.json}
 *
...
runImport({
  slug: 'minos',
  lang: 'en',
  rawPath: join(HERE, 'raw', 'tlg0059.tlg033.perseus-eng2.xml'),
  outDir: join(REPO_ROOT, 'data', 'plato-minos-en'),
});
