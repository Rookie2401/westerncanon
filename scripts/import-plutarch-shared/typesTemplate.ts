/**
 * The byte-identical `types.ts` written into every one of the 132
 * `data/plutarch-<slug>-{grc,en}/` directories (generated, not hand-edited -
 * mirrors scripts/import-archimedes-shared/typesTemplate.ts /
 * data/de-bello-gallico-la/types.ts).
 */

export const PLUTARCH_TYPES_FILE = `/**
