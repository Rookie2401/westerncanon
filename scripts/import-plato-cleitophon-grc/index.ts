/**
 * Plato, Cleitophon — Greek text (ed. John Burnet, Platonis Opera;
 * CTS urn:cts:greekLit:tlg0059.tlg029.perseus-grc2).
 * Run-once ingestion pipeline built on the shared tokenizer in
 * scripts/import-plato-b-shared/parse.ts.
 *
 *   npx tsx scripts/import-plato-cleitophon-grc/index.ts
 *
 * Reads scripts/import-plato-cleitophon-grc/raw/tlg0059.tlg029.perseus-grc2.xml
 * (already in the repo; nothing is downloaded) and writes
 *   data/plato-cleitophon-grc/{work.json,about.json,anomalies.json}
 *
...
runImport({
  slug: 'cleitophon',
  lang: 'grc',
  rawPath: join(HERE, 'raw', 'tlg0059.tlg029.perseus-grc2.xml'),
  outDir: join(REPO_ROOT, 'data', 'plato-cleitophon-grc'),
});
