/**
 * Shared text helpers for the Plato dialogue importers.
 *
 * Guiding rule (mirrors scripts/import-isagoge-shared/text.ts and every
 * other importer in this repo): never discard or silently correct source
 * text. We only:
