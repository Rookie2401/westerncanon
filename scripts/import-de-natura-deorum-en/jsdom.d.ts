 ...
 * surface scripts/import-de-natura-deorum-en/parseYonge1888.ts actually
 * uses. Copied from (not shared with) scripts/import-aristotle-shared/jsdom.d.ts
 * — each importer keeps its own copy since each importer's tsconfig program
 * only needs its own surface (same rationale as that file's sibling copies).
 *
