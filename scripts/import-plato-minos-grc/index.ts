/**
 * Plato, Minos — Greek text (ed. John Burnet, Platonis Opera;
 * CTS urn:cts:greekLit:tlg0059.tlg033.perseus-grc2).
 * Run-once ingestion pipeline built on the shared tokenizer in
 * scripts/import-plato-b-shared/parse.ts.
 *
 *   npx tsx scripts/import-plato-minos-grc/index.ts
 *
 * Reads scripts/import-plato-minos-grc/raw/tlg0059.tlg033.perseus-grc2.xml
 * (already in the repo; nothing is downloaded) and writes
 *   data/plato-minos-grc/{work.json,about.json,anomalies.json}
 *
...
runImport({
  slug: 'minos',
  lang: 'grc',
  rawPath: join(HERE, 'raw', 'tlg0059.tlg033.perseus-grc2.xml'),
  outDir: join(REPO_ROOT, 'data', 'plato-minos-grc'),
});
